...
var port = 7777 || process.env.PORT || config.dev.port
...
var devMiddleware = devMiddleware(compiler, {
...
app.use(staticCache(path.join(process.cwd(), 'static'), {
  maxAge: 365 * 24 * 60 * 60
}))
...
devMiddleware.origin.waitUntilValid(() => {
